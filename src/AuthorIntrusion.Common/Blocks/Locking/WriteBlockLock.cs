...
{
	/// <summary>
	/// Implements a write lock on the given block. This intended to be used
	/// in an using() code block and released once the lock is no longer
	/// needed.
	/// </summary>
	public class WriteBlockLock: IDisposable
	{
		#region Constructors

		/// <summary>
		/// Acquires a read lock on the collection and then a write lock on the
		/// block.
		/// </summary>
			...
			ReaderWriterLockSlim readerWriterLock)
		{
			...
			blockLock = new NestableWriteLock(readerWriterLock);
		}
		...
		private NestableWriteLock blockLock;
